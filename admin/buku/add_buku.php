<?php
//kode 9 digit jika ID Buku tidak diisi
				...
				<form action="" method="post" enctype="multipart/form-data">
					<div class="box-body">
						<div class="form-group">
							<label>ID Buku</label>
							<input type="text" name="id_buku" id="id_buku" class="form-control" placeholder="ID Buku (Opsional)">
						</div>
...
if (isset($_POST['Simpan'])) {
    // Menggunakan ID dari input jika diisi, jika tidak maka pakai ID otomatis
    $id_buku = $_POST['id_buku'] ? $_POST['id_buku'] : $format;
